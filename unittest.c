...
void test_rsa_sign()
{
    ...
    plain_len = rsa_sign(pvk_bin, pvk_bin_len, cipher_bin, 16, plain);
...
void test_rsa_encode_pvk_to_pem_str()
{
...
-----END RSA PRIVATE KEY-----\n";
    ...
    int ret = rsa_encode_pvk_to_pem_str(pvk, pvk_len, str);
...
void test_rsa_encode_pvk_to_pem_file()
{
    char* pvk_hex = "";
...
-----END RSA PRIVATE KEY-----\n";
    ...
    int ret = rsa_encode_pvk_to_pem_file(pvk, pvk_len, file_name);
...
int main(int argc, char* argv[]) {
    ...
    RUN_TEST(test_rsa_encode_pvk_to_pem_file);
